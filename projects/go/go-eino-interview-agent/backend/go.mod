...
require (
	...
	github.com/cloudwego/eino-ext/components/document/parser/pdf v0.0.0-20260529100130-76aad4b2f680
	github.com/cloudwego/eino-ext/components/document/transformer/splitter/recursive v0.0.0-20260611025447-20b2a55477df
	github.com/cloudwego/eino-ext/components/embedding/ark v0.1.0
	github.com/cloudwego/eino-ext/components/indexer/milvus v0.0.0-20260611025447-20b2a55477df
	github.com/cloudwego/eino-ext/components/model/openai v0.1.13
	github.com/cloudwego/eino-ext/components/retriever/milvus v0.0.0-20260611025447-20b2a55477df
