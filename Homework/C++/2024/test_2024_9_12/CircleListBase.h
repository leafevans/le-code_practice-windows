...
class CircleListBase : public LinkListBase<T, NodeType> {
 public:
  ...
  virtual CircleListBase &operator=(const CircleListBase<T, NodeType> &src);  // 重载等于号
  void clear();  // 清空链表
...
template<class T, class NodeType>
CircleListBase<T, NodeType>
::CircleListBase(const CircleListBase<T, NodeType> &src) {
  *this = src;  // 拷贝函数
}

template<class T, class NodeType>
CircleListBase<T, NodeType> &CircleListBase<T, NodeType>
::operator=(const CircleListBase<T, NodeType> &src) {
